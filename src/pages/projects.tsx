...
export default function ProjectsPage() {
  ...
  return (
    <div id="projects" className="mt-20" data-aos="fade-right">
      <Head>
          <title>Projects | Gustavo Portfolio</title>
      </Head>
      <div id="title" className="relative">
        <h2 className="text-5xl ml-9  pointer-events-none absolute left-24 -top-4 z-0 -translate-x-1/2 transform font-bold uppercase text-heading opacity-15 text-white opacity-20">Projects</h2>
